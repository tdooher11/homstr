...
$subject = "New message from HOMSTR - Partners Page";
$message = 'FROM: '.$name.'
Email: '.$email.'
Message: '.$message;
$headers = 'From:'.$email. "\r\n";
				...
				<form action="<?php echo $_SERVER['PHP_SELF']?>" method="post" id="contact-form">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-4 contact-info cta-message wow fadeInLeft">
							<address>
								Have an idea of how your company can work together with Homstr? Please fill out the form to the right and we'll contact you soon to setup a time to speak.
							</address>
						</div>	
